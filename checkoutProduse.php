...
<?php
    if(isset($_SESSION['checkout_status']) && $_SESSION['checkout_status'] != 0 && !empty($_SESSION['produseCos'])){
        include_once 'account/checkout.php';
    } else{
        include_once 'account/cos_cumparaturi.php';
    }
?>
