...
class create_accountp3{
    ...
    {
        $this->conn = $conn;
        $this->nume_pren = $_SESSION['nume_prenume_cont_nou'];
    ...
    public function createp3(){
        ...
        $this->cont_final = "INSERT INTO conturi (nume_prenume,password,email,telefon,data_nasterii,stare) VALUES ('$this->nume_pren', '".$this->psw."', '".$this->email."', '".$this->telefon."', '".$this->data_nasterii."', 0);";
        mysqli_query($this->conn,$this->cont_final);
        header('Location: ../index.php?Cont_creat_cu_succes'); 
        exit();
    }
