...
class mesaj{
    ...
    public function msg(){
        $this->cod = "INSERT INTO mesaje (nume_prenume,email,telefon,mesaj,subiect,data_plasare,stare) VALUES ('$this->nume_prenume', '$this->email', '$this->telefon', '$this->mesaj', '$this->subiect',current_timestamp(),'0')";
