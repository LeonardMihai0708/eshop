            ...
            <form action="includes/create_accountp2.php" method="POST">
                ...
                if(isset($_GET['probleme']))
                    switch ($_GET['probleme']) {
                        case "telefon":
                            echo 'Acest număr de telefon este folosit deja!</td>';
                            break;
                        default:
                            echo '<h1>CREARE CONT</h1>';
                            break;
                ...
                <input type="tel" id="Telefon" name="telefon" placeholder="Telefon.."  pattern="^(\+4|)?(07[0-8]{1}[0-9]{1}|02[0-9]{2}|03[0-9]{2}){1}?(\s|\.|\-)?([0-9]{3}(\s|\.|\-|)){2}$" required>
                <br>
